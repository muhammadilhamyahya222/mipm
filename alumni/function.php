...
$conn = mysqli_connect("localhost", "root", "", "mipm");
    ...
    function query($query) {
        ...
        function tambahDataAlumni($data) {
            ...
            $testi = mysqli_real_escape_string($conn, stripslashes(strip_tags(htmlspecialchars($data["testi"]))));
            // Upload gambar
            ...
            $query = "INSERT INTO alumni
                    VALUES
                    ('', '$nama', '$jk', '$tgl_lahir', '$tahun_lulus', '$nis', '$alamat', '$email', '$telepon', '$handphone', '$fotoAlumni', '$testi', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP) ";
