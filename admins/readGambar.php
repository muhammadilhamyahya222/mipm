          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-<?= $gambar["kategori"];?>">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p style="text-transform: capitalize"><?= $gambar["nama_gambar"];?></p>
                <div class="portfolio-links">
                  <a href="../assets/img/portfolio/<?= $gambar["gambar1"];?>" data-gall="portfolioGallery" class="venobox" title="App 1"><i class="ri-add-fill"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-<?= $gambar["kategori"];?>">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p style="text-transform: capitalize"><?= $gambar["nama_gambar"];?></p>
                <div class="portfolio-links">
                  <a href="../assets/img/portfolio/<?= $gambar["gambar2"];?>" data-gall="portfolioGallery" class="venobox" title="App 1"><i class="ri-add-fill"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-<?= $gambar["kategori"];?>">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p style="text-transform: capitalize"><?= $gambar["nama_gambar"];?></p>
                <div class="portfolio-links">
                  <a href="../assets/img/portfolio/<?= $gambar["gambar3"];?>" data-gall="portfolioGallery" class="venobox" title="App 1"><i class="ri-add-fill"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-<?= $gambar["kategori"];?>">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p style="text-transform: capitalize"><?= $gambar["nama_gambar"];?></p>
                <div class="portfolio-links">
                  <a href="../assets/img/portfolio/<?= $gambar["gambar4"];?>" data-gall="portfolioGallery" class="venobox" title="App 1"><i class="ri-add-fill"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-<?= $gambar["kategori"];?>">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p style="text-transform: capitalize"><?= $gambar["nama_gambar"];?></p>
                <div class="portfolio-links">
                  <a href="../assets/img/portfolio/<?= $gambar["gambar5"];?>" data-gall="portfolioGallery" class="venobox" title="App 1"><i class="ri-add-fill"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-<?= $gambar["kategori"];?>">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p style="text-transform: capitalize"><?= $gambar["nama_gambar"];?></p>
                <div class="portfolio-links">
                  <a href="../assets/img/portfolio/<?= $gambar["gambar6"];?>" data-gall="portfolioGallery" class="venobox" title="App 1"><i class="ri-add-fill"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-<?= $gambar["kategori"];?>">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p style="text-transform: capitalize"><?= $gambar["nama_gambar"];?></p>
                <div class="portfolio-links">
                  <a href="../assets/img/portfolio/<?= $gambar["gambar7"];?>" data-gall="portfolioGallery" class="venobox" title="App 1"><i class="ri-add-fill"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-<?= $gambar["kategori"];?>">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p style="text-transform: capitalize"><?= $gambar["nama_gambar"];?></p>
                <div class="portfolio-links">
                  <a href="../assets/img/portfolio/<?= $gambar["gambar8"];?>" data-gall="portfolioGallery" class="venobox" title="App 1"><i class="ri-add-fill"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-<?= $gambar["kategori"];?>">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p style="text-transform: capitalize"><?= $gambar["nama_gambar"];?></p>
                <div class="portfolio-links">
                  <a href="../assets/img/portfolio/<?= $gambar["gambar9"];?>" data-gall="portfolioGallery" class="venobox" title="App 1"><i class="ri-add-fill"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-<?= $gambar["kategori"];?>">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p style="text-transform: capitalize"><?= $gambar["nama_gambar"];?></p>
                <div class="portfolio-links">
                  <a href="../assets/img/portfolio/<?= $gambar["gambar10"];?>" data-gall="portfolioGallery" class="venobox" title="App 1"><i class="ri-add-fill"></i></a>
                </div>
              </div>
            </div>
          </div>
