  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo mr-auto">
        <h1><a href="index.php"><img class="logo" src="../assets/img/mi/logonav.png"> MIPM</a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="drop-down"><a href="">Lain-lain</a>
            <ul>
              <li><a href="tambahGambar.php">Tambah Gambar</a></li>
              <li><a href="tambahArtikel.php">Tambah Artikel</a></li>
              <li><a href="siswa/index.php">Data Siswa</a></li>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-<?= $row["kategori"];?>">
          ...
          <img src="../assets/img/portfolio/<?= $row["gambar1"];?>" class="img-fluid" alt="<?= $row["nama_gambar"];?>">
            <div class="portfolio-info">
              <h4><?= $row["nama_gambar"];?></h4>
              <p style="text-transform: capitalize"><?= $row["kategori"];?></p>
            </div>
          </div>
            <br>
            <a href="ubahGambar.php?id=<?= $row["id"];?>" class="badge badge-warning">Ubah</a>
            <a href="hapusGambar.php?id=<?= $row["id"];?>" class="badge badge-danger" onclick=" return confirm('Hapus gambar?');">Hapus</a>     
        </div>
        <?php endforeach; ?>
          <a href="readAllGambar.php">
    ...
    <section id="team" class="team">
      <div class="container">
        ...
        <?php foreach($artikel as $row) : ?>
          <a href="readArtikel.php?id=<?= $row["id"];?>">
          <div class="col-lg-6">
          <br>
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="../assets/img/artikel/<?= $row["logo"];?>" class="img-fluid" alt=""></div>
              <div class="member-info">
              <h4><a href="readArtikel.php?id=<?= $row["id"];?>"><?= $row["judul"];?></a></h4>
                <p><?= $row["p1"];?></p>
              </div>
            </div>
            <br>
            <a href="ubahArtikel.php?id=<?= $row["id"];?>" class="badge badge-warning">Ubah</a>
            <a href="hapusArtikel.php?id=<?= $row["id"];?>" class="badge badge-danger" onclick=" return confirm('Hapus file ?');">Hapus</a>
          </div>
          </a>
          <?php endforeach; ?>
          <div class="col-lg-6">
            ...
            <div class="member d-flex align-items-start">
              <div class="member-info">
                <h4><a href="readAllArtikel.php" title="Lebih lanjut">Baca Semua Artikel</h4></a>
              </div>
            </div>
          </div>  
        </div>
