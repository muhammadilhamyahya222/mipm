...
$conn = mysqli_connect("localhost", "root", "", "mipm");
    ...
    function tambahDataSiswa($data) {
        ...
        $query = "INSERT INTO data_siswa
                VALUES
                ('', '$no_urut', '$no_induk', '$nama', '$jk', '$tmp_lahir', '$tgl_lahir', '$anak_ke', '$jml_sdr', '$alamat', '$tlp', '$nama_ayah',
                 '$nama_ibu', '$pekerjaan', '$pedp', '$k_ortu', '$asal_sekolah', '$kelas', '$nisn', '$username', '$password', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP) ";
