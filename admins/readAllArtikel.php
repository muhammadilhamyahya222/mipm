      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <br>
            <a href="../admins/ubahArtikel.php?id=<?= $row["id"];?>" class="badge badge-warning">Ubah</a>
            <a href="../admins/hapusArtikel.php?id=<?= $row["id"];?>" class="badge badge-danger" onclick=" return confirm('Hapus file ?');">Hapus</a>
          </div>
          <?php endforeach; ?>
        </div>
